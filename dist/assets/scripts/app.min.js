...
/******/ 	var hotCurrentHash = "69c4f7b873c57ee59eca"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	function initShares() {
	    var buttons = (0, _jquery2.default)('.jsShareButton');
	    buttons.each(function (i, button) {
	        button = (0, _jquery2.default)(button);
	        button.click(function () {
	            var link = encodeURI(location.href);
	            if (button.data('service') == 'email') {
	                window.location.href = "mailto:?" + 'subject=' + escape('New Google Play') + '&body=' + 'Hi, check out this project - http://googleplay.flatata.com. I hope it will help you with your projects.';
	            } else {
	                var tLink = encodeURI(link),
	                    title = '',
	                    description = '',
	                    image = '',
	                    meta = (0, _jquery2.default)('meta');
	                ...
	                var interval = window.setInterval(function () {
	                    try {
	                        if (page == null || page['closed']) {
	                            ...
	                            if (!button.hasClass('screenShare')) addLike(button.data('service'));else addLike(button.data('service'), button.closest('[data-content]').data('content'), button.closest('.screen').data('screen'));
	                        }
	                    } catch (e) {}
	                }, 1000);
	            }
	...
	(0, _jquery2.default)(function () {
	    ...
	    var swiperSectionInfo = (0, _swiper2.default)('.section--info .swiper-container--section', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var _typeof2=__webpack_require__(6);var _typeof3=_interopRequireDefault(_typeof2);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}/**
	 * Swiper 3.3.1
...
/***/ function(module, exports) {
	...
	$(function () {
	  ...
	  $comparison.on('mousedown.comparision vmousedown.comparision init.comparision', function (e) {
	    ...
	    var moveSeparator = function moveSeparator(leftValue) {
	    ...
	    $body.on('mousemove.comparision vmousemove.comparision', function (e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (addon) {
	    ...
	    if (true) {
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(84)], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
	    ...
	    UI.component('parallax', {
	        ...
	        init: function init() {
	            ...
	            (0, _keys2.default)(this.options).forEach(function (prop) {
	        ...
	        update: function update(percent) {
	            ...
	            (0, _keys2.default)(this.props).forEach(function (prop) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;/*! UIkit 2.26.4 | http://www.getuikit.com | (c) 2014 YOOtheme | MIT License */
	(function(core) {
